    ...
    def get_user_email(self):
        ...
        for i in range(10):
            ...
            for recipient in emailmsg.recipients:
                email_addresses[recipient.email] = email_addresses.get(recipient.email, 0) + 1
            email_addresses[emailmsg.sender.email] = email_addresses.get(emailmsg.sender.email, 0) + 1
...
if __name__ == "__main__":
    ...
    print(summary_2.user_email)
    print(summary_2.summary)

    for i in summary_2.summary:
        print(summary_2.summary[i])
        for keys in summary_2.summary[i]:
            print(keys)
    # summary_2.plot()
    # summary.plot()