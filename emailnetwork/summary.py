        ...
        for i in range(10):
            ...
            for recipient in emailmsg.recipients:
                email_addresses[recipient.email] = (
                    email_addresses.get(recipient.email, 0) + 1
                )
            email_addresses[emailmsg.sender.email] = (
                email_addresses.get(emailmsg.sender.email, 0) + 1
            )
...
if __name__ == "__main__":
    ...
    reader = MBoxReader(
        "/Users/vincentiuscalvin/Documents/Supertype/mbox-dataset/Ori_Sample_01.mbox"
    )
